This is a small application written in JS with Imap module that reads and saves raw e-mail data to txt files.
...
- Fetched emails will be saved in "mail" directory.
